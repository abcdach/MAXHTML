...
var iot__Last_Selected_InOut_Type = 0;// 1 - input / 2 - output
////////////////////////////////////////////////////////
var Popup_window = 0;
            ...
            if(Device_Index != -1){
                if (iot__Device[Device_Index].Device_Delete_Status === 0) {
                    ...
                    if (d < (parseInt(this.ellipse_size / 2))) {
						...
						//LOG_TERMINAL("CREATE OutPut DEV_ID : " + _iot__Selected_Device_name + " Index : " + index + "\n");
                        //////////////////////////////////////////////////////
                        return 1;
                    }
                    //INPUT DEL ##################################################
                    ...
                    if (d < (parseInt(this.ellipse_size / 2))) {
						...
						//LOG_TERMINAL("CREATE InPut DEV_ID : " + _iot__Selected_Device_name + " Index : " + index + "\n");
						//////////////////////////////////////////////////////
                        return 1;
                    }
                    //############################################################
    ...
    this._mousePressed = function(X, Y) {
        ...
        if (this.mouseStatus === 1) {
            ...
            if (iot__GLOBAL_Lock === 0) {
                ...
                if (this.Device_Type === 2) dom__File.show(this.x, this.y, this.Device_name, this.Device_Index, this.Description, this.Device_Type);
...
function OBJECT_iot__Device_InPut(Device_name, InPut_index, CREATOR, Status) {
    ...
    this._mousePressed = function() {
        ...
        if (d < (parseInt(this.SizeW / 2))) {
			iot__Last_Selected_InOut_Type = 1;
			...
			dom__InOUT.show( this.Device_name, this.InPut_index,  this.Description, "InPut",this.Status );
...
function OBJECT_iot__Device_OutPut(Device_name, OutPut_index, CREATOR, Status) {
    ...
    this._mousePressed = function() {
        ...
        var d = dist(mouseX, mouseY, this.x, this.y);
        if (d < (parseInt(this.SizeW / 2))) {
			iot__Last_Selected_InOut_Type = 2;
			...
			dom__InOUT.show( this.Device_name, this.OutPut_index,  this.Description, "OutPut",this.Status );
...
function draw__VCB() {
   ...
   if( iot__Last_Selected_InOut_Type === 2){
	    ...
	    if (DEVICE_INDEX !== -1) {
           ...
           // text(_Time_Delta, Popup_window_x, Popup_window_y +16+5); 
			dom__InOUT_Inp2.value(_Description);
	    	dom__InOUT_Inp3.value(_TIME);
			dom__InOUT_Inp4.value(_Time_Delta);
			dom__InOUT_Inp5.value(_DATA);
