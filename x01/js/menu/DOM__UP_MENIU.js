...
function Menu_init() {
    ...
    ///////////////////////////////////////////////
    room_y = createImg('pic/room/room_y.jpg');
    room_y.position(364, 34 + MD);
    room_y.style('width', '50px');
    room_y.hide();  
	room_y.mousePressed(dom__Rooms.show);
	room_y.mouseOver(function(){room_y.style('width', '49px');});
    room_y.mouseOut (function(){room_y.style('width', '50px');});
    ///////////////////////////////////////////////	
